...
export default function RateScreen() {
  ...
  async function handleSubmit() {
    ...
    const rateeId = booking.contractor_id === userId ? booking.worker_id : booking.contractor_id
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => router.replace('/(worker)/home' as any)} style={styles.skip}>
