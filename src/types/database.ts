  ...
  public: {
    Tables: {
      ...
      instant_bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "instant_bookings_contractor_id_fkey"
          ...
          {
            foreignKeyName: "instant_bookings_worker_id_fkey"
            columns: ["worker_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cleanup_stale_workers: { Args: never; Returns: undefined }
